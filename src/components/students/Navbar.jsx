...
const Navbar = () => {
  ...
  return (
    <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-gray-500 py-4 bg ${isCourseList ? 'bg-white' : 'bg-cyan-100/70'}`}>
      ...
      <div className='md:hidden flex items-center gap-2 sm:gap-5 text-gray-500'>
        ...
        {user ? <UserButton/> : <img onClick={() => openSignIn()} src={assets.user_icon}/>}
      </div>
    </div>
  )
}
